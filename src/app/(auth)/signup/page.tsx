...
function SignupForm() {
  ...
  // Pre-fill email from ?email= (marketing page email capture)
  useEffect(() => {
    if (emailParam) {
      // async boundary — avoids cascading synchronous renders in the effect
      const t = setTimeout(() => setEmail(emailParam), 0);
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="text-center">
        <h2 className="font-heading text-xl font-semibold tracking-tight">Create your account</h2>
      ...
      <button
        ...
        className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-border bg-card text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 hover:bg-muted/50 hover:shadow-sm active:scale-[0.98] active:translate-y-0 disabled:pointer-events-none disabled:opacity-70"
      >
        {googleLoading ? (
