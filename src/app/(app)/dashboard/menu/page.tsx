...
const CATALOG_CONFIG: Record<string, {
  ...
  food_beverage: {
    title: "Menu",
    subtitle: "Manage your food categories, items, variants, and add-ons.",
    addItemLabel: "Add Item",
    searchPlaceholder: "Search menu items...",
    filters: ["All", "Veg", "Non-Veg", "Bestsellers"],
    durationLabel: "Prep time (mins)",
    isFood: true,
    defaultEmoji: "🍕",
  },
  salon_spa: {
    title: "Services & Pricing",
    subtitle: "Manage your salon & spa services, prices, and packages.",
    addItemLabel: "Add Service",
    searchPlaceholder: "Search services...",
    filters: ["All", "Bestsellers", "Popular"],
  ...
  healthcare: {
    ...
    subtitle: "Manage consultation services, treatments, tests, and fees.",
    addItemLabel: "Add Service",
    searchPlaceholder: "Search services & treatments...",
    filters: ["All", "Bestsellers", "Popular"],
    durationLabel: "Duration (mins)",
    isFood: false,
    defaultEmoji: "🏥",
  ...
  education: {
    ...
    subtitle: "Manage courses, batch schedules, fees, and program details.",
  ...
  retail: {
    ...
    subtitle: "Manage your product catalog, prices, variants, and stock.",
  ...
  services: {
    ...
    subtitle: "Manage your service offerings, rates, and packages.",
    addItemLabel: "Add Service",
    searchPlaceholder: "Search services...",
    filters: ["All", "Bestsellers", "Popular"],
    durationLabel: "Est. Duration (mins)",
    isFood: false,
    defaultEmoji: "🔧",
  },
};
...
export default function MenuPage() {
  ...
  const catalog = CATALOG_CONFIG[businessType] || CATALOG_CONFIG.food_beverage;
    ...
    <div className="space-y-6">
      ...
      {showAddItem && (
        <div className="rounded-2xl border border-primary/20 bg-primary/5 p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-semibold">{catalog.addItemLabel}</h3>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <input
              ...
              placeholder={`${catalog.addItemLabel} Name`}
            ...
            {catalog.durationLabel && (
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={catalog.durationLabel}
                  min="1"
                  max="120"
            ...
            <input
              ...
              className={`flex h-10 rounded-xl border border-input bg-card px-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 ${catalog.durationLabel ? 'sm:col-span-2' : ''}`}
            />
          </div>
              ...
              {AVAILABLE_TAGS.map((tag) => {
                ...
                return (
                  ...
                  >
                    ...
                    {tag.value === 'chefs_special' && !catalog.isFood ? 'Featured' : tag.label}
